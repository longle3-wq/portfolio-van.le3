(function () {
  function init() {
    ...
    if (!root || typeof TimelineMax === 'undefined' || typeof TweenMax === 'undefined') return;

    var cat = root.querySelector('.cat');
    var head = root.querySelector('.head');
    var eyes = root.querySelectorAll('.eyes circle');
    var eyel = root.querySelectorAll('.eyes-l');
    var eyer = root.querySelectorAll('.eyes-r');
    var ears = root.querySelectorAll('.ears');
    var earsl = root.querySelector('.ears-l');
    var earsr = root.querySelector('.ears-r');
    var tail = root.querySelector('.tail');
    var backlegs = root.querySelector('.backlegs');
    var frontlegs = root.querySelector('.frontlegs');
    var frontlegs1 = root.querySelector('.frontlegs1');
    var backcircle = root.querySelector('.body-backcircle');
    var frontcircle = root.querySelector('.body-frontcircle');
    var bodybetween = root.querySelector('.body-between');
    var logo = root.querySelector('.logoani');
